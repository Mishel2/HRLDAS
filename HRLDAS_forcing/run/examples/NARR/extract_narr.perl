...
$data_dir = "/home/mishel/data/NARR/raw";
$results_dir = "/home/mishel/data/NARR/extracted";
...
for $hr (@hrs)
 {
  ...
  $file = `ls ${data_dir}/merged_AWIP32.20$yy$nums[$mon]$nums[$day]$hr`;
  chop($file);

  system ("wgrib -s $file | grep ':$var' | wgrib -i -grib $file -o $results_dir/$var/NARR_$var.20$yy$nums[$mon]$nums[$day]$hr.grb ");
